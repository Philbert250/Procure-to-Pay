...
import { createPurchaseRequest, getRequestTypes } from '../../services/requests';
...
const CreateRequest = () => {
  ...
  const createMutation = useMutation({
    mutationFn: async (data) => {
      ...
      return createPurchaseRequest(formData);
    },
    onSuccess: () => {
        ...
        <div className={`rounded-xl shadow-lg p-4 sm:p-6 transition-colors ${
          ...
          <div className="mb-6">
            ...
            <p className={`mt-1 text-xs ${
              ...
              Upload a proforma invoice. If provided, items will be automatically extracted. Otherwise, add items manually below.
            </p>
          </div>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
              <label className={`block text-sm font-medium ${
                ...
                Items (Optional - only if no proforma)
              </label>
              <button
                type="button"
                onClick={addItem}
            ...
            {fields.length === 0 && !proformaFile && (
              <p className={`text-sm ${
                isDark ? 'text-gray-400' : 'text-gray-500'
              }`}>
                No items added. Either upload a proforma invoice or add items manually.
              </p>
            )}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            <button
              type="submit"
              disabled={createMutation.isLoading || formIsSubmitting}
            ...
            >
              {createMutation.isLoading || formIsSubmitting ? (
                <>
